...
5. Click **"Build Mosaic"** — the process runs in the background, QGIS stays
   usable, progress & logs show in the dialog, and it can be canceled anytime via
   the **"Cancel"** button
6. When finished, the result is automatically loaded into the QGIS canvas
...
Issues and pull requests are welcome — please use the [issue tracker](https://github.com/muhammadkholifatkhurrohman-spec/SkyStitch-Drone-Orthomosaic/issues).
